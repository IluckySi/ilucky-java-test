...
//	}
//
//	public void init1(String queueName) {
...
//            sendMessage(session, producer, queueName);
//            session.commit();
//        } catch (Exception e) {
//            e.printStackTrace();
//        } finally {
...
//    }
//
//    public void sendMessage(Session session, MessageProducer producer, String queueName) {
//
//    	try{
//    		for (int i = 1; i <= SEND_NUMBER; i++) {
//                TextMessage message = session.createTextMessage("ActiveMq Send Message : "
//                        + i);
//                message.setStringProperty("CLOUDWISE", "request_info");
//                // 发送消息到目的地方
//                System.out.println(queueName + " Send Message : " + "ActiveMq Send Message : " + i);
//                producer.send(message);
//                //System.out.println("MessageProducer : " + producer);
//            }
//    	}catch(Exception ex){
//    		ex.printStackTrace();
//    	}

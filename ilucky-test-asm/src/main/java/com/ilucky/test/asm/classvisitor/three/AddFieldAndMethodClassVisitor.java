 ...
 *
 */
public class AddFieldAndMethodClassVisitor extends ClassVisitor implements Opcodes {
	...
	public AddFieldAndMethodClassVisitor(int api, ClassVisitor cv, String fname, String fdesc,
   ...
   public void visitEnd() {
	   ...
	   if(!isIncludeMethod) {
	       ...
	       if (mv != null) {
	           ...
	           mv.visitFieldInsn(GETFIELD, "com/ilucky/test/asm/classvisitor/three/User", fname, fdesc);

...
public class MyMethodVisitor extends MethodVisitor implements Opcodes {
    ...
    /**
     * Label used for enclosing method code into try..finally block to intercept
     * thrown exceptions.
     */
    private final Label startLabel = new Label();
    private final Label endLable = new Label();
    ...
    public void visitMaxs(int maxStack, int maxLocals) {
        ...
        mv.visitMethodInsn(INVOKESTATIC, SUMBITTER, EXCEPTION, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V", false);
        mv.visitInsn(ATHROW);
        // Visits a try catch block.
        // 注意: 针对捕获的异常是无法抓取的
        mv.visitTryCatchBlock(startLabel, endLable, handlerLabel, null);
...
如果没有如下逻辑,会报如下错误:
if (Type.VOID == returnType.getSort()) {
原因是: 此时操作数栈顶没有值,所有执行dup指令的时候,会报错(Attempt to pop empty stack)
...
如果报如下异常:
java.lang.VerifyError: Expecting a stackmap frame at branch target 51
解决方案参考: https://blog.csdn.net/lxlmycsdnfree/article/details/78093187?locationNum=10&fps=1
添加jvm参数: -XX:-UseSplitVerifier
*/
